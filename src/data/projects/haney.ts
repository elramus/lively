...
export const haney: Project = {
	...
	description:
		'Creative Senior Producer Bryan Haney wanted a straightforward but exciting website to showcase his high-profile work. I built him a custom WordPress theme that allows him to easily manage his portfolio himself and features a memorable and interesting take on the horizontal accordion design pattern.',
	approach: [
	...
	galleryImgsSm: [haneyImgs.oneSm, haneyImgs.twoSm, haneyImgs.threeSm],
	galleryImgsLg: [haneyImgs.oneLg, haneyImgs.twoLg, haneyImgs.threeLg],
	tech: [
		{
			icon: ['fab', 'js'],
