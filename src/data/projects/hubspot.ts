...
export const hubspot: Project = {
	...
	galleryImgsSm: [hubspotImgs.oneSm, hubspotImgs.twoSm, hubspotImgs.threeSm, hubspotImgs.fourSm],
	galleryImgsLg: [hubspotImgs.oneLg, hubspotImgs.twoLg, hubspotImgs.threeLg, hubspotImgs.fourLg],
	tech: [
		{
			icon: ['fab', 'js'],
